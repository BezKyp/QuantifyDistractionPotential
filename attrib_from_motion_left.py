        ...
        for l1 in lines:
            if len(l1[0]) != 0:
                ...
                if int(l[0]) == int(img.replace(".jpg","")):
                    ...
                    # get box
                    i = src[int(float(l[3])):int(float(l[5])), int(float(l[2])):int(float(l[4]))]
                    center_shape = shapely.box(float(l[2]), float(l[3]), float(l[4]), float(l[5]))
                    ...
                    # static proportion
                    box_diag = math.dist((float(l[2]), float(l[3])), (float(l[4]), float(l[5])))
